===============================================================================
=   Д оVim -- это очень мощный редактор, имеющий множество команд, слишком много
...
--->  В момегт набора этой строки кое-кто с трудом попвдал по клваишам!
...
---> Несколько слов в этой строке требует редактирования.
...
---> Конец этой строки нуждается в помощи команда  с$ .
...
r 3. Нажмите  :  и внизу экрана появится  :'<,'> .
...
---> Эта стро позволит вам попрактиков в добавле текста.dgfokgogdvfg
